...
2. 减少人工回归测试的工作量
3. 其它类型的自动化测试成本太高，单元测试虽然需要对代码进行改动，但相对成本较低
4. 提升代码的可读性和可维护性，降低代码维护的成本
5. 提升代码的可扩展性和灵活性，更容易响应需求的变化

## 遗留代码单元测试的难点

遗留代码在编写之初没有考虑测试，代码基本不具备可测试性。对于单元测试来说，最直接的感受就是被测方法不好测：

1. 被测方法代码太长太复杂（没有设计，用过程式的一个大方法完成所有功能），设计测试用例很困难
2. 被测方法代码依赖太多（如构造复杂的框架对象），准备测试环境很困难
...
2. 熟悉 IDE 提供的常用的“安全”重构手法，和一些解依赖的方法。
...
第五步，**整洁代码**：对有测试保障的代码进一步重构，消除重复，提升代码可读性。
